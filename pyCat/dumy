...
class Config:
    ...
    def get_config():
        ...
        try:
            ...
            Config.exec_path = conf.get('Hashcat', 'Hashcat_Exec_Path')
            Config.session_name = conf.get('Hashcat', 'Hashcat_Session')
            Config.benchmark_score = int(conf.get('Hashcat', 'Benchmark_Score'))
            Config.outfile_path = conf.get('Outfile', 'Hashcat_Out_File')
            Config.outfile_chk_dir = conf.get('Outfile', 'Outfile_check_dir')
            Config.temp_path = conf.get('Hashcat', 'Hashcat_Temp_Path')
            snc = conf.get('Outfile', 'Outfile_check_enable')
            if snc == '1':
